...
import connectDB from './config/db';           // make this a default export that returns a Promise
...
// Global error handler (4 args - keep signature to be recognized as error middleware)
...
export const startServer = async () => {
  try {
    // Wait for the DB to connect before listening
    await connectDB();
